...
urlpatterns += i18n.i18n_patterns(
    ...
    url(_(r'^receipt-bank-landing-page/'), 'cloudmeb.pages.views.receipt_bank_landing', name='receipt_bank_landing_page'),
    url(_(r'^receipt-bank-landing-page-freetrial/'), 'cloudmeb.pages.views.receipt_bank_landing_freetrial', name='receipt_bank_landing_page_freetrial'),
