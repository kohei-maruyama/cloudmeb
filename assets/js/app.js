...
$(document).ready(function(e) {
    ...
    $('.modal .btn-add-more').on('click', function(e) {
        ...
        setTimeout(
            function() {
                ...
                $('.price-popup .alert').fadeIn(0).delay(3000).fadeOut(500);
            },
        500 * itemNumber + 1500);
    });
    ...
    $('.actions a.remove-btn').on('click', function(e) {
        var msg,
            ...
            solutionName = $solution.find('.individual-head > h4').text();
    ...
    $('.contact-form-content button').on('click', function(e) {
    ...
    $('.contact-second-form-content button').on('click', function(e) {
        var $form = $(this).closest('form'),
            data = $form.serializeObject(),
            isValidated = true,
            msg;
    ...
    // Click Event Handler on Try it now for free button in Receipt Bank page
    $('#free-trial-sign-modal .btn-signup-modal').on('click', function(e) {
        var $modal = $(this).closest('.modal'),
            $form = $modal.find('form'),
            data = $form.serializeObject(),
            isValidated = true,
        ...
        .done(function(response, status, xhr) {
            if (response == '200') {
                ...
                growl(msg, 'success', true);
                $modal.find('.close').click();
                trackEvent('freesignup', 'submitted', 1);
            } else {
                msg = ['<strong>', '</strong>'].join(gettext('We were unable to deliver your partnership request, please try again later.'));
                growl(msg, 'danger', true);
            }
    ...
    $('#free-trial-sign-modal .btn-dismiss-modal').on('click', function(e) {
        trackEvent('freesignup', 'canceled', 0);
    });
